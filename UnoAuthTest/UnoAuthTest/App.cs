...
namespace UnoAuthTest
{
    public class App : PrismApplication
    {
        ...
        auth.AddCustom(custom =>
                custom
                    .Login((sp, dispatcher, credentials, cancellationToken) =>
                    {
                        ...
                        if (credentials?.TryGetValue("LoginViewModel.Username", out var username) ?? false &&
        ...
        {
            containerRegistry.RegisterForNavigation<ViewTest, ViewTestViewModel>();
        }
    }
}
